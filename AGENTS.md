...
The expected flow is: HTTP -> Interface -> Application -> Domain -> Repository Interface -> Infrastructure -> MySQL -> Domain Event -> Event Publisher -> SQS -> Worker -> Event Handler -> Asynchronous Processing.
